...
* mobile device.
* Progam your own shader function in `aVegetarianSinceTheInvasion` in DayGloDisplay.metal.
...
do {
  let path = Bundle.main.path(forResource: "DayGloDisplay", ofType: "metal")
...
renderer.functionName = "aVegetarianSinceTheInvasion"
